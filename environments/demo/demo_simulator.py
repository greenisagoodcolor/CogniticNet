...
class DemoSimulator:
    ...
    def update_agent_stats(self, agent_id: str, action_result: Dict[str, Any]):
        ...
        try:
            with self.db_conn.cursor() as cursor:
                if action_result['success']:
                    ...
                    if action_result['action'] in ['share_discovery', 'share_knowledge']:
    ...
    def log_demo_event(self, event_type: str, agent_id: Optional[str], 
        ...
        while self.running:
            try:
                ...
                self.log_demo_event(
                    ...
                    {'conversation_type': conversation['type'], 'participant_ids': [agent1['id'], agent2['id']]}
                )
