...
class CompatibilityTester:
    ...
    def run_tests(self, package_dir: Path, 
                 hardware_profile: Optional[HardwareProfile] = None) -> Dict[str, Any]:
        """
    ...
    def _run_test(self, test: CompatibilityTest, package_dir: Path,
    ...
    def _test_cpu_performance(self, package_dir: Path,
                            hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
    ...
    def _test_memory_allocation(self, package_dir: Path,
                              hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
    ...
    def _test_disk_io(self, package_dir: Path,
                     hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
    ...
    def _test_python_packages(self, package_dir: Path,
                            hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
        ...
        try:
            ...
            return (
                False,
                f"Package test failed: {str(e)}",
                {'error': str(e)}
            )
    
    def _test_network(self, package_dir: Path,
                     hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
    ...
    def _test_gpu(self, package_dir: Path,
                 hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
    ...
    def _test_agent_startup(self, package_dir: Path,
                          hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
        """Test agent startup."""
        ...
        try:
            ...
            return (
                False,
                f"Agent startup test failed: {str(e)}",
                {'error': str(e)}
            )
    
    def _test_resource_limits(self, package_dir: Path,
                            hardware_profile: HardwareProfile) -> Tuple[bool, str, Dict]:
        ...
        try:
            ...
            return (
                False,
                f"Resource limit test failed: {str(e)}",
                {'error': str(e)}
            )
