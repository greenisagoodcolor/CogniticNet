...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('active', 'inactive', 'suspended', 'terminated', name='agentstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('type', postgresql.ENUM('direct', 'group', 'broadcast', 'system', name='conversationtype'), nullable=True),
    ...
    op.create_index('idx_log_component_timestamp', 'system_logs', ['component', 'timestamp'], unique=False)
    ...
    op.create_index('idx_knowledge_owner_type', 'knowledge_graphs', ['owner_id', 'type'], unique=False)
    ...
    op.create_index('idx_participant_active', 'conversation_participants', ['conversation_id', 'is_active'], unique=False)
    ...
    op.create_index('idx_coalition_member_active', 'coalition_members', ['coalition_id', 'is_active'], unique=False)
