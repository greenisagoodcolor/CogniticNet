...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "active", "inactive", "suspended", "terminated", name="agentstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            postgresql.ENUM(
                "direct", "group", "broadcast", "system", name="conversationtype"
            ),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_coalition_status_type", "coalitions", ["status", "type"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["coalition_id"], ["coalitions.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "idx_log_timestamp_level", "system_logs", ["timestamp", "level"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_knowledge_graphs_id"), "knowledge_graphs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_knowledge_graphs_uuid"), "knowledge_graphs", ["uuid"], unique=True
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "conversation_id", "agent_id", name="uq_conversation_agent"
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["agent_id"], ["agents.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["coalition_id"], ["coalitions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
