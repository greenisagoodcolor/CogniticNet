...
class LocalLLMManager:
    ...
    def _try_generate(self, provider: LocalLLMProvider, 
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            'current_provider': type(self.current_provider).__name__ if self.current_provider else None,
    ...
    def optimize_for_hardware(self, ram_gb: float, cpu_cores: int, 
                            has_gpu: bool = False) -> LocalLLMConfig:
        """
        ...
        logger.info(f"Optimized config for {ram_gb}GB RAM, {cpu_cores} cores: "
