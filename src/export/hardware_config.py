...
class HardwareDetector:
    ...
    def detect_capabilities() -> HardwareCapabilities:
        ...
        # Detect GPU
        caps.gpu_available, caps.gpu_model, caps.gpu_memory_gb = (
    ...
    def customize_profile(
        ...
        profile = OptimizationProfile(
            ...
            inference_threads=min(
                base_profile.inference_threads, capabilities.cpu_threads // 2
            ),
...
class RuntimeConfigurator:
    ...
    @staticmethod
    def validate_config(
        config: Dict[str, Any], capabilities: HardwareCapabilities
    ) -> List[str]:
