...
class HardwareOptimizer:
    ...
    def customize_profile(self, base_profile: OptimizationProfile,
    ...
    def _is_raspberry_pi_hardware(self, caps: HardwareCapabilities) -> bool:
        ...
        return (
            ...
            caps.cpu_cores == 4 and
            4 <= caps.ram_total_gb <= 8 and
            'videocore' in caps.accelerators
        )
    
    def _is_jetson_hardware(self, caps: HardwareCapabilities) -> bool:
        """Check if capabilities match Jetson."""
        return (
            'aarch64' in platform.machine().lower() and
            'cuda' in caps.accelerators and
            caps.ram_total_gb <= 8
        )
...
class RuntimeConfigurator:
    ...
    @staticmethod
    def generate_runtime_config(profile: OptimizationProfile,
