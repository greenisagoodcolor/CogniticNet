...
class StateSnapshot:
    ...
    def add_component(self, component_type: StateComponent, data: Any):
        ...
        checksum = hashlib.sha256(data_str.encode() if isinstance(data_str, str) else data_str).hexdigest()
...
class SerializationRequirementsManager:
    ...
    def _define_default_requirements(self) -> Dict[StateComponent, SerializationRequirement]:
...
class StateDataCatalog:
    ...
    def generate_serialization_plan(self, components: List[StateComponent]) -> Dict[str, Any]:
        ...
        component_structures = {
            ...
            StateComponent.COMMUNICATION_CHANNELS: ["message_history", "active_conversations"],
