...
class StateVerifier:
    ...
    def verify_valid_positions(self,
                             pre_state: SimulationState,
                             post_state: SimulationState,
                             world: H3World) -> List[BugReport]:
    ...
    def verify_resource_consistency(self,
                                  pre_state: SimulationState,
                                  post_state: SimulationState,
                                  world: H3World) -> List[BugReport]:
    ...
    def verify_movement_validity(self,
                               pre_state: SimulationState,
                               post_state: SimulationState,
                               world: H3World) -> List[BugReport]:
    ...
    def verify_no_teleportation(self,
                              pre_state: SimulationState,
                              post_state: SimulationState,
                              world: H3World) -> List[BugReport]:
    ...
    def verify_no_resource_duplication(self,
                                     pre_state: SimulationState,
                                     post_state: SimulationState,
                                     world: H3World) -> List[BugReport]:
...
class BugCheckedSimulation:
    ...
    def capture_state(self) -> SimulationState:
        ...
        for agent_id, agent in self.engine.agents.items():
            agent_state = {
                ...
                "beliefs": len(agent.knowledge_graph.graph.nodes()) if hasattr(agent, 'knowledge_graph') else 0
            }
    ...
    def run(self, steps: int) -> Dict[str, Any]:
        ...
        report = {
            ...
            "final_state": self.state_history[-1].to_dict() if self.state_history else None
        }
        
        logger.info(f"Simulation completed: {successful_steps}/{steps} successful steps")
