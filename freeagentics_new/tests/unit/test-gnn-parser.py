...
from .......inference.gnn.parser import GNNParser, GNNLexer, GNNBlockParser, GNNSyntaxError, Token, ASTNode, ParseResult, SectionType
...
class TestGNNBlockParser:
    ...
    def test_parse_simple_object(self):
        ...
        tokens = [Token('LBRACE', '{', 1, 1), Token('IDENTIFIER', 'type', 1, 3), Token('COLON', ':', 1, 7), Token('STRING', '"GraphSAGE"', 1, 9), Token('RBRACE', '}', 1, 21)]
    ...
    def test_parse_numbers(self):
        ...
        tokens = [Token('IDENTIFIER', 'integer', 1, 1), Token('COLON', ':', 1, 8), Token('NUMBER', '42', 1, 10), Token('IDENTIFIER', 'float', 2, 1), Token('COLON', ':', 2, 6), Token('NUMBER', '3.14', 2, 8), Token('IDENTIFIER', 'negative', 3, 1), Token('COLON', ':', 3, 9), Token('NUMBER', '-10', 3, 11)]
        parser = GNNBlockParser(tokens)
        result = parser.parse()
    ...
    def test_parse_booleans(self):
        ...
        tokens = [Token('IDENTIFIER', 'flag1', 1, 1), Token('COLON', ':', 1, 6), Token('IDENTIFIER', 'true', 1, 8), Token('IDENTIFIER', 'flag2', 2, 1), Token('COLON', ':', 2, 6), Token('IDENTIFIER', 'false', 2, 8)]
        parser = GNNBlockParser(tokens)
        result = parser.parse()
