...
class HexCell:
    ...
    def coordinates(self) -> Tuple[float, float]:
        ...
        return h3.h3_to_geo(self.hex_id)
...
class H3World:
    ...
    def __init__(
        ...
        # Get center hex
        self.center_hex = h3.geo_to_h3(center_lat, center_lng, resolution)
        ...
        logger.info(
            f"Created H3World with {len(self.cells)} cells at resolution {resolution}"
        )

    def _generate_world(self):
        """Generate the hexagonal world with biomes and terrain."""
        # Get all hexagons within num_rings of center
        hex_ids = h3.k_ring_distances(self.center_hex, self.num_rings)
    ...
    def _calculate_biome(
        self, temperature: float, moisture: float, elevation: float
    ) -> Biome:
    ...
    def _generate_resources(
        self, biome: Biome, terrain: TerrainType
    ) -> Dict[str, float]:
    ...
    def get_neighbors(self, hex_id: str) -> List[HexCell]:
        ...
        neighbor_ids = h3.k_ring(hex_id, 1)
    ...
    def get_cells_in_range(self, hex_id: str, range: int) -> List[HexCell]:
        ...
        cell_ids = h3.k_ring(hex_id, range)
    ...
    def calculate_path(self, start_hex: str, end_hex: str) -> Optional[List[str]]:
        ...
        path = h3.h3_line(start_hex, end_hex)
