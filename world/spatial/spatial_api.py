...
class ResourceDistribution:
    ...
    def calculate_amount(self, hex_id: str, distance_from_origin: float = 0) -> float:
        ...
        if self.distribution_pattern == 'uniform':
            ...
            distance = h3.h3_distance(hex_id, self.gradient_origin)
...
class ObservationModel:
    ...
    def is_visible(self,
        ...
        # Check line of sight
        line = h3.h3_line(observer_hex, target_hex)
...
class SpatialAPI:
    ...
    def get_neighbors_at_distance(self, hex_id: str, k: int) -> Dict[int, List[str]]:
        ...
        rings = h3.k_ring_distances(hex_id, k)
    ...
    def set_observation_model(self, model: ObservationModel):
    ...
    def get_visible_hexes(self,
        ...
        for k in range(1, range_rings + 1):
            for hex_id in h3.k_ring(observer_hex, k):
    ...
    def query_region(self,
        ...
        for hex_id in h3.k_ring(center, radius_hexes):
