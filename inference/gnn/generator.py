...
class GNNGenerator:
    ...
    def generate_base_model(self, agent_name: str, agent_class: str, 
        ...
        """
        # Get base template for class
        template = self._get_class_template(agent_class)
        
        # Create model with personality-based customizations
        model = {
            "model": {
                "name": agent_name,
    ...
    def refine_model(self, current_model: Dict[str, Any], patterns: List[Dict[str, Any]], 
    ...
    def _generate_state_space(self, agent_class: str, personality: Dict[str, float]) -> Dict[str, Any]:
        ...
        # Base states common to all agents
        state_space = {
            "S_energy": {
                "type": "Real[0,100]",
        ...
        # Add personality-influenced states
    ...
    def _generate_connections(self, personality: Dict[str, float]) -> Dict[str, Any]:
        ...
        # Calculate preference weights from personality
        ...
        # Add personality-specific connections
        if personality.get("curiosity", 0) > 0.7:
    ...
    def _generate_update_equations(self, personality: Dict[str, float]) -> Dict[str, Any]:
        ...
        # Base learning rate influenced by curiosity
        ...
        equations = {
            "belief_update": {
                ...
                "parameters": {
                    "learning_rate": round(base_learning_rate, 3)
                }
            },
            "energy_dynamics": {
                "state": "S_energy",
        ...
        # Add personality-specific equations
    ...
    def _apply_pattern_to_model(self, model: Dict[str, Any], pattern: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if pattern_type == "successful_action_sequence":
            ...
            # Adjust preference weights based on outcomes
        ...
        # Only return change record if changes were made
        return change_record if change_record["changes"] else None
    
    def generate_from_experience(self, base_model: Dict[str, Any], 
                               experience_summary: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        # Add experience-based states if needed
...
if __name__ == "__main__":
    ...
    # Example patterns for refinement
    patterns = [
        {
            "type": "successful_action_sequence",
