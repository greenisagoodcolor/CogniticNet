...
class ModelQuantizer:
    ...
    def _manual_ggml_quantize(self, model_path: Path, output_path: Path, 
                             quant_type: str) -> Dict[str, Any]:
    ...
    def benchmark_quantized_model(self, original_path: Path, 
                                quantized_path: Path,
...
class EdgeOptimizer:
    ...
    def optimize_for_device(self, model_path: Path, device_type: str,
    ...
    def _create_deployment_package(self, model_path: Path, device_type: str,
                                 profile: Dict[str, Any], output_dir: Path):
...
def auto_quantize(model_path: Path, target_size_mb: Optional[float] = None,
                 target_device: Optional[str] = None) -> Path:
    """
