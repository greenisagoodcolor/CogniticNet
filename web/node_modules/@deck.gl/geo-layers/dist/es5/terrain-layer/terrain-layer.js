...
var defaultProps = _objectSpread(_objectSpread({}, _tileLayer.default.defaultProps), {}, {
  elevationData: _tileset2d.urlType,
  texture: _objectSpread(_objectSpread({}, _tileset2d.urlType), {}, {
    optional: true
  }),
  meshMaxError: {
    type: 'number',
...
var TerrainLayer = function (_CompositeLayer) {
  ...
  (0, _createClass2.default)(TerrainLayer, [{
    ...
    value: function getTiledTerrainData(tile) {
      ...
      var dataUrl = (0, _tileset2d.getURLFromTemplate)(elevationData, tile);
      var textureUrl = texture && (0, _tileset2d.getURLFromTemplate)(texture, tile);
