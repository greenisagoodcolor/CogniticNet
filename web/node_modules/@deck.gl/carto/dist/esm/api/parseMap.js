import { AGGREGATION, getLayer, getColorAccessor, getColorValueAccessor, getSizeAccessor, getTextAccessor, OPACITY_MAP, opacityToAlpha, getIconUrlAccessor, negateAccessor, getMaxMarkerSize } from './layer-map';
...
function createChannelProps(id, type, config, visualChannels, data) {
  ...
  if (textLabel && textLabel.length && textLabel[0].field) {
    ...
    result._subLayerProps = { ...result._subLayerProps,
      'points-text': {
