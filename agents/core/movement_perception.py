                ...
                "cells": [
                    {
                        ...
                        "distance": h3.h3_distance(
                            self.current_cell.hex_id, cell.hex_id
                        ),
    ...
    def _apply_line_of_sight(
        ...
        for target_cell in potential_visible:
            ...
            for i, hex_id in enumerate(path[1:-1], 1):  # Skip observer and target
                ...
                if (
                    intermediate_cell.elevation > expected_elevation + 10
                ):  # 10m tolerance
                    blocked = True
                    break
...
if __name__ == "__main__":
    ...
    world = H3World(
        center_lat=37.7749, center_lng=-122.4194, resolution=7, num_rings=5, seed=42
    )
