...
from ..models.validated_models import Position, MessageType, AgentStatus
...
class ActiveInferenceAgent:
    ...
    def _initialize_generative_model(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "preference_model": {
                ...
                "exploration": self.executor.model.metadata.get(
    ...
    def _can_perform_action(
        ...
        if action_type == "move":
            ...
            return (
                "nearby_resources" in world_state
                and len(world_state["nearby_resources"]) > 0
            )
        elif action_type == "communicate":
            # Check if other agents are nearby
            return (
                "nearby_agents" in world_state and len(world_state["nearby_agents"]) > 0
            )
    ...
    def _calculate_expected_free_energy(
        ...
        energy_cost = (
            self.generative_model["transition_model"]
            .get(action_type, {})
            .get("energy_cost", 0.0)
        )
