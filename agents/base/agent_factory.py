...
from .data_model import Agent as AgentData, Position, AgentPersonality, AgentCapability
...
class AgentFactory(IAgentFactory):
    ...
    def _create_explorer_agent(self, **kwargs) -> BaseAgent:
        ...
        from .behaviors import ExplorationBehavior, create_behavior_tree
    ...
    def _create_merchant_agent(self, **kwargs) -> BaseAgent:
        ...
        from .data_model import ResourceAgent
