...
class IWorldActionInterface(ABC):
    ...
    @abstractmethod
    def perform_action(self, agent_id: str, action_type: ActionType,
                      parameters: Dict[str, Any]) -> ActionResult:
        """Perform an action in the world."""
        pass

    @abstractmethod
    def validate_action(self, agent_id: str, action_type: ActionType,
                       parameters: Dict[str, Any]) -> bool:
        """Check if an action is valid."""
        pass

    @abstractmethod
    def get_action_cost(self, agent_id: str, action_type: ActionType,
...
class IWorldEventSystem(ABC):
    ...
    @abstractmethod
    def subscribe_to_events(self, agent_id: str, event_types: List[EventType],
                           callback: Callable[[WorldEvent], None]) -> None:
...
class WorldEventSystem(IWorldEventSystem):
    ...
    def publish_event(self, event: WorldEvent) -> None:
        ...
        for agent_id, callback in subscribers.items():
            ...
            if (not event.affected_agents or
                agent_id in event.affected_agents or
...
class AgentWorldManager:
    ...
    def __init__(self, world, spatial_api=None):
        self.world = world
    ...
    def perceive_environment(self, agent_id: str) -> Optional[Perception]:
        ...
        movement_options = [neighbor.hex_id for neighbor in neighbors
                          if neighbor.movement_cost < float('inf')]  # Exclude impassable terrain
    ...
    def _calculate_action_cost(self, agent_id: str, action_type: ActionType,
                              parameters: Dict[str, Any]) -> float:
    ...
    def _perform_move_action(self, agent_id: str, parameters: Dict[str, Any],
                           cost: float) -> ActionResult:
    ...
    def _perform_harvest_action(self, agent_id: str, parameters: Dict[str, Any],
                               cost: float) -> ActionResult:
    ...
    def _perform_observe_action(self, agent_id: str, parameters: Dict[str, Any],
                               cost: float) -> ActionResult:
    ...
    def _perform_communicate_action(self, agent_id: str, parameters: Dict[str, Any],
                                   cost: float) -> ActionResult:
    ...
    def _perform_build_action(self, agent_id: str, parameters: Dict[str, Any],
                             cost: float) -> ActionResult:
...
class AgentWorldManager:
    ...
    def _perform_deposit_action(self, agent_id: str, parameters: Dict[str, Any],
                               cost: float) -> ActionResult:
