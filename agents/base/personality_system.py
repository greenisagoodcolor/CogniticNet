...
from .data_model import AgentPersonality, PersonalityTraits
...
class PersonalityTrait:
    ...
    def get_effective_value(self) -> float:
        ...
        expired_modifiers = []
        for modifier_name, (modifier_value, expiry_time) in self.temporary_modifiers.items():
    ...
    def evolve_trait(self, experience_impact: float, context: str = "") -> None:
        ...
        evolution_amount = (experience_impact * self.definition.evolution_rate * 
                          (1 - self.definition.stability))
...
class PersonalitySystem:
    ...
    def create_personality_profile(self, 
                                 ...
                                 random_variation: float = 0.1) -> 'PersonalityProfile':
    ...
    def calculate_behavior_modifier(self, 
...
class PersonalityProfile:
    ...
    def _initialize_traits(self, 
                         trait_values: Optional[Dict[str, float]] = None,
                         random_variation: float = 0.1) -> None:
    ...
    def _generate_personality_summary(self) -> None:
        ...
        self.personality_summary = "; ".join(summary_parts) if summary_parts else "Balanced personality"
    ...
    def modify_trait_temporarily(self, trait_name: str, modifier: float, duration: timedelta) -> None:
    ...
    def evolve_traits_from_experience(self, experience_data: Dict[str, Any]) -> None:
        ...
        if experience_type == "exploration":
            ...
            if social_context:
                ...
                self._evolve_trait_if_exists("agreeableness", base_impact if success else -base_impact, "social_experience")
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], personality_system: PersonalitySystem) -> 'PersonalityProfile':
                ...
                if trait_name in profile.traits:
                    ...
                    if "evolution_history" in trait_data:
                        trait.evolution_history = [
                            (datetime.fromisoformat(h["timestamp"]), h["change"], h["context"])
...
def create_personality_profile(agent_type: str = "basic", 
                             trait_values: Optional[Dict[str, float]] = None) -> PersonalityProfile:
