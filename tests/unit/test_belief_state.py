"""
Unit tests for BeliefState module

Tests core belief state functionality including discrete and continuous
belief representations, updates, serialization, and state transitions.
"""
...
class TestDiscreteBeliefState:
    ...
    def test_initialization_with_priors(self, config):
    ...
    def test_get_set_beliefs(self, belief_state):
    ...
    def test_bayesian_update(self, belief_state):
    ...
    def test_linear_update(self, belief_state):
    ...
    def test_momentum_update(self, belief_state):
    ...
    def test_entropy_calculation(self, belief_state):
    ...
    def test_most_likely_state(self, belief_state):
    ...
    def test_top_k_states(self, belief_state):
    ...
    def test_sampling(self, belief_state):
        """Test state sampling."""
    ...
    def test_temperature_sampling(self, belief_state):
    ...
    def test_kl_divergence(self, belief_state):
    ...
    def test_history_tracking(self, belief_state):
    ...
    def test_reset_to_uniform(self, belief_state):
    ...
    def test_compression(self, belief_state):
    ...
    def test_clone(self, belief_state):
    ...
    def test_serialization(self, belief_state):
    ...
    def test_file_save_load(self, belief_state):
...
class TestContinuousBeliefState:
    ...
    def test_gaussian_bayesian_update(self, belief_state):
    ...
    def test_kalman_update(self, belief_state):
    ...
    def test_sampling(self, belief_state):
        ...
        samples = belief_state.sample_state(num_samples=10)
        assert samples.shape == (10, 3)

        # Samples should be roughly centered around mean
        sample_mean = samples.mean(dim=0)
        assert torch.allclose(sample_mean, belief_state.mean, atol=0.5)


class TestFactoryFunctions:
    """Test factory functions for belief state creation."""

    def test_create_discrete_belief_state(self):
    ...
    def test_create_continuous_belief_state(self):
    ...
    def test_create_belief_state_factory(self):
...
class TestBeliefStateIntegration:
    ...
    def test_discrete_belief_with_inference(self):
        """Test discrete belief state with inference algorithms."""
        from inference.engine import VariationalMessagePassing, InferenceConfig, DiscreteGenerativeModel, ModelDimensions, ModelParameters
