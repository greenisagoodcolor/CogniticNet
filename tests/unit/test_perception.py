...
class TestStimulus(unittest.TestCase):
    ...
    def test_stimulus_creation(self):
        ...
        stimulus = Stimulus(stimulus_id='test_stim', stimulus_type=StimulusType.OBJECT, position=pos, intensity=0.8)
    ...
    def test_decay_over_distance(self):
        ...
        stimulus = Stimulus(stimulus_id='test', stimulus_type=StimulusType.SOUND, position=Position(0, 0, 0), intensity=1.0, radius=10.0)
...
class TestPerceptionCapabilities(unittest.TestCase):
    ...
    def test_custom_capabilities(self):
        ...
        cap = PerceptionCapabilities(visual_range=30.0, hearing_range=150.0, enabled_types={PerceptionType.VISUAL})
...
class TestAuditorySensor(unittest.TestCase):
    ...
    def test_sound_detection(self):
        ...
        sound = Stimulus('sound1', StimulusType.SOUND, Position(20, 0, 0), intensity=0.8, radius=30.0)
    ...
    def test_sound_decay(self):
        ...
        sound = Stimulus('sound', StimulusType.SOUND, Position(15, 0, 0), intensity=1.0, radius=20.0)
        percepts = self.sensor.sense(self.agent, [sound])
        self.assertEqual(len(percepts), 1)
...
class TestPerceptionFilters(unittest.TestCase):
    ...
    def test_importance_filter(self):
        ...
        percepts = [Percept(danger_stimulus, PerceptionType.VISUAL, confidence=0.3, distance=20), Percept(object_stimulus, PerceptionType.VISUAL, confidence=0.4, distance=50)]
    ...
    def test_attention_filter(self):
        ...
        for i in range(5):
            ...
            percept = Percept(stim, PerceptionType.VISUAL, confidence=1.0 - i * 0.1, distance=float(i))
...
class TestPerceptionSystem(unittest.TestCase):
    ...
    def test_can_perceive(self):
        ...
        self.assertTrue(self.perception_system.can_perceive(self.agent1.agent_id, self.agent2.agent_id, PerceptionType.VISUAL))
        self.agent2.position = Position(100, 0, 0)
        self.state_manager.update_agent_position(self.agent2.agent_id, self.agent2.position)
        self.assertFalse(self.perception_system.can_perceive(self.agent1.agent_id, self.agent2.agent_id, PerceptionType.VISUAL))

    def test_sound_perception(self):
        """Test perceiving sounds"""
        sound = self.perception_system.create_sound_stimulus(Position(15, 0, 0), intensity=1.0, radius=20.0)
