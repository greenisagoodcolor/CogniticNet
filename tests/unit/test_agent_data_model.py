...
class TestAgentPersonality(unittest.TestCase):
    ...
    def test_personality_validation(self):
        ...
        # Test invalid values (would need to set directly since dataclass prevents this at init)
...
class TestAgent(unittest.TestCase):
    ...
    def test_memory_management(self):
        ...
        # Test memory trimming (would need to add 100+ experiences)
        for i in range(110):
...
class TestSpecializedAgents(unittest.TestCase):
    ...
    def test_resource_agent(self):
        ...
        # Check resource-specific properties
    ...
    def test_social_agent(self):
        ...
        # Check social-specific properties
