"""
Unit tests for Active Inference inference algorithms
"""
...
class TestVariationalMessagePassing:
    ...
    def test_single_observation_inference(self):
        ...
        assert beliefs[1] > 0.8  # Should be confident about state 1

    def test_batch_observation_inference(self):
        ...
        assert beliefs[1, 1] > 0.8
        assert beliefs[2, 2] > 0.8

    def test_observation_distribution_inference(self):
...
class TestGradientDescentInference:
    ...
    def test_free_energy_continuous(self):
...
class TestNaturalGradientInference:
    ...
    def test_natural_vs_standard_gradient(self):
