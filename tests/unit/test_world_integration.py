...
from agents.base.world_integration import (
    AgentWorldManager, WorldEventSystem, ActionType, EventType,
    WorldEvent, Perception, ActionResult, IWorldPerceptionInterface,
    IWorldActionInterface, IWorldEventSystem
)
...
class TestAgentWorldManager(unittest.TestCase):
    ...
    def test_perceive_environment_invalid_agent(self):
    ...
    def test_perform_harvest_nonexistent_resource(self):
        ...
        result = self.manager.perform_action(
            "agent1",
            ActionType.HARVEST_RESOURCE,
            {"resource_type": "nonexistent", "amount": 10.0}
        )
        
        self.assertFalse(result.success)
        self.assertIn("not available", result.message)
        
    def test_perform_deposit_action(self):
        ...
        result = self.manager.perform_action(
            ...
            {"resource_type": "water", "amount": 5.0}
        )
    ...
    def test_perform_communicate_action(self):
        ...
        result = self.manager.perform_action(
            ...
            {"target_agent": "agent2", "message": "Hello"}
        )
    ...
    def test_perform_build_action(self):
    ...
    def test_restore_agent_energy_cap(self):
...
class TestWorldIntegrationInterfaces(unittest.TestCase):
    ...
    def test_perception_interface_compliance(self):
