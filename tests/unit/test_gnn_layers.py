"""
Unit tests for GNN Layer Implementations
...
class TestGCNLayer:
    ...
    def test_cached_normalization(self):
        ...
        # Second forward pass should use cached values
...
class TestGATLayer:
    ...
    def test_initialization(self):
        ...
        assert layer.lin_src.weight.shape == (256, 32)  # 4 * 64
    ...
    def test_forward_pass(self):
        ...
        # With concat=True (default), output has heads * out_channels
        assert out.shape == (10, 256)  # 4 * 64

    def test_without_concat(self):
        ...
        # Without concat, heads are averaged
        assert out.shape == (10, 64)
    ...
    def test_attention_weights(self):
        ...
        assert alpha.shape[1] == 4  # number of heads
...
class TestResGNNLayer:
    ...
    def test_different_dimensions(self):
        ...
        assert out.shape == (10, 64)
        assert hasattr(layer.residual, 'weight')  # Linear transformation
...
class TestGNNStack:
    ...
    def test_different_layer_types(self):
        ...
        for layer_type in ['gcn', 'gat', 'sage', 'gin', 'edgeconv']:
            ...
            if layer_type == 'gat':
                # GAT with default concat=True
                assert out.shape == (10, 64)  # 1 head * 64
            else:
                assert out.shape == (10, 64)
    ...
    def test_with_residual(self):
        ...
        # Check that residual layers are created
