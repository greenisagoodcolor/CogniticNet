# GNN Processing Core - Architecture Diagrams

This document contains detailed architecture diagrams for the GNN Processing Core components.
...
graph TB
    ...
    subgraph "Core Services"
        ...
        subgraph "Generation Service"
            ArchitectureSelector[Architecture Selector]
    ...
    DependencyResolver --> NLPProcessor
    NLPProcessor --> ParameterExtractor
    ParameterExtractor --> SemanticMapper

    SemanticMapper --> ArchitectureSelector
    ArchitectureSelector --> LayerBuilder
    LayerBuilder --> ModelAssembler
```
...
graph LR
    ...
    Normalized --> NLFeatures
    NLFeatures --> Parameters
...
## GNN Model Processing Flow

```mermaid
stateDiagram-v2
    [*] --> Submitted: User submits .gnn.md
    ...
    Mapped --> Generating: Generate GNN model
