...
+----------------+   +----------------+   +----------------+   +----------------+
```
*(Note: This is a conceptual model. The Application layer is an implicit set of use cases that orchestrate the domain, not necessarily a top-level directory)*
